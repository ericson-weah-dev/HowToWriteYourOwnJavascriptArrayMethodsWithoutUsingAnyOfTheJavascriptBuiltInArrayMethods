...
(global => {
  ...
  const lastIndexOf = (array = [], searchElement, fromIndex, len = length(array)) => {
    ...
    | the lastIndexOf object by assigning it to module.exports
    |
    |
    */
    
    if (typeof module !== 'undefined' && module.exports)  module.exports = lastIndexOf;
    ...
    | in the browser) by assigning it to global.lastIndexOf.
    |
    */

    else global.lastIndexOf = lastIndexOf;
})(this)