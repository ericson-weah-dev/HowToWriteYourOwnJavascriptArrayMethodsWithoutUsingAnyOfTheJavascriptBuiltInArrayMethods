...
(global => {
    ...
    */
    ...
    | the reverse object by assigning it to module.exports
    |
    |
    */
    
    if (typeof module !== 'undefined' && module.exports)  module.exports = reverse;
    ...
    | in the browser) by assigning it to global.reverse.
    |
    */

    else global.reverse = reverse;
})(this)